...
bool BaseApplication::configure(void)
{
   ...
   // if(mRoot->showConfigDialog())
	if(manualInitialize("OpenGL Rendering Subsystem"))
    {
        // If returned true, user clicked OK so initialise
        // Here we choose to let the system create a default rendering window by passing 'true'
        mWindow = mRoot->initialise(true, "Bludiste Render Window");
...
//---------------------------------------------------------------------------
///This function manualy set parameters of rendering window
bool BaseApplication::manualInitialize(const std::string &desiredRenderer)
{
    ...
    {
        renderSystem = (*it);
        if(desiredRenderer==renderSystem->getName())
        {
            ok = true;
            break;
        }
